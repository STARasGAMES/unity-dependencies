...
namespace SaG.Utilities.Editor
{
    public static class SerializedPropertyUtility
    {
        public static SerializedProperty FindPropertyRelativeOrFail(this SerializedProperty property, string path)
        {
            ...
            if (subProperty == null)
            {
                throw new InvalidOperationException(
                    $"Failed to find property '{SerializedObjectLabel(property.serializedObject)}.{property.propertyPath}.{path}'.");
            }
        ...
        public static SerializedProperty FindPropertyOrFail(this SerializedObject serializedObject, string path)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Failed to find property '{SerializedObjectLabel(serializedObject)}.{path}'.");
            }
        ...
        private static void GetUnderlying(this SerializedProperty property, out object parent, out FieldInfo field,
            out object value)
        {
        ...
        public static void WriteArray<T>(this SerializedProperty property, T[] array,
